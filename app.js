...
app.get('/', (req, res) => {
  res.send(`
    ...
    <html lang="en">
      ...
      <body>
        <div class="container">
          <h1>✅ Node.js Marketing App  "Version 4"  is Running on Kubernetes! and CI/CD Pipeline Jenkins and Argo Successfully work!!!!!</h1>
...
app.get('/hello', (req, res) => {
  res.send('👋 Hello, World! Welcome to Eihu YouTube Channel.');
});
